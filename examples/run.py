...
from .role_play import RolePlaying
...
def main():
    ...
    # default_task = "搜索大疆action 5pro的价格"
    default_task = (
        "查看目录\"/Users/zyq/workspace/manus_project/lenovo/data\"下的照片，根据图片内容生成一个旅游游记markdown, 存储在当前目录的trip_log_mcp.md中。markdown内容包含图片(图片引用使用绝对路径)以及对应的内容描述，整体构成一个完整旅行叙事。"
    )
